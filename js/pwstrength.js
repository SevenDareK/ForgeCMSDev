...
(function ($, ui) {
    ...
    ui.initProgressBar = function (options, $el) {
        var $container = ui.getContainer(options, $el),
            progressbar = "<div style=\"width:209%;\" class='progress'><div class='";
    ...
    ui.initVerdict = function (options, $el) {
        ui.initHelper(options, $el, "<span class='password-verdict' style=\"margin-top-8px;position:absolute;\"></span>",
